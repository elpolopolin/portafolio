...
function App() {
  ...
  const skills = ["React", "JavaScript (ES6+)", "Node.js", "Express", "Tailwind CSS", "HTML5 & CSS3", "Python", "Git & GitHub", "SQL", "Firebase", "REST APIs", "CRUD operations", "Responsive design", "Authentication & Authorization"];
